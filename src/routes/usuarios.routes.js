...
import {iniciarSesionUsuario,registrarUsuario,desloguear, guardarReceta, quitarReceta, misRecetaFavoritas} from "../controllers/usuarios.controllers.js"
...
routerUsuarios.get('/:idUsuario', misRecetaFavoritas)